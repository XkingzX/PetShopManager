...
namespace DeTai_QuanLyCuaHangThuCung
{
    public partial class frm_NhapKho : Form
    {
        ...
        public frm_NhapKho(string title, string buttonText, string mode = "Add", string maSP = "", string tenSP = "", string giaSP = "", string loaiSP = "", string mota = "")
        {
            InitializeComponent();
            this.Text = title;
        ...
        private void btn_luu_Click(object sender, EventArgs e)
        {
            if (string.IsNullOrWhiteSpace(txt_maPK.Text) ||
                ...
                string.IsNullOrWhiteSpace(txt_ngaynhap.Text) ||
